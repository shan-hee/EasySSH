...
const connectDatabase = () => {
    ...
    `);
        ...
        `);
                insert.run('系统信息', '收集服务器系统信息：内存、磁盘、CPU基本信息', 'free -h && df -h && cat /proc/cpuinfo | grep "model name" | head -1', '系统管理员', JSON.stringify(['系统', '监控']), JSON.stringify(['系统', '信息', '内存', '磁盘', 'cpu', 'free', 'df']), '系统监控', 1, // is_public
                1, // is_system
                0, // usage_count
                null, // created_by
                now, now);
