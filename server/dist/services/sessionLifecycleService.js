...
class SessionLifecycleService {
    ...
    register(sessionId, options = {}) {
        ...
        context.signal.addEventListener('abort', () => {
            ...
            __classPrivateFieldGet(this, _SessionLifecycleService_instances, "m", _SessionLifecycleService_cleanup).call(this, sessionId);
        }, { once: true });
...
_SessionLifecycleService_instances = new WeakSet(), _SessionLifecycleService_cleanup = function _SessionLifecycleService_cleanup(sessionId) {
    const context = this.sessions.get(sessionId);
    if (!context) {
        return;
    }
