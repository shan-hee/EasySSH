...
```bash
docker stop easyssh && docker rm easyssh && docker pull shanheee/easyssh:latest && docker run -d --name easyssh -p 8520:8520 shanheee/easyssh:latest && echo "EasySSH 快速更新完成！"
```
