...
if [ "$CONFIRM" = "y" ] || [ "$CONFIRM" = "Y" ]; then
  ...
  if [ "$PUSH_CONFIRM" = "y" ] || [ "$PUSH_CONFIRM" = "Y" ]; then
    ...
    echo -e "   - shanhee/easyssh-backend:v${VERSION}"
    echo -e "   - shanhee/easyssh-backend:latest"
    echo -e "   - shanhee/easyssh-frontend:v${VERSION}"
    echo -e "   - shanhee/easyssh-frontend:latest"
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}\n"
