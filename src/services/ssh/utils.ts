 ...
 */
export function parseCloseCode(code: number, reason?: string): string {
 ...
 */
export function getWebSocketUrl(host: string, port: number, path: string, useSSL: boolean = false): string {
