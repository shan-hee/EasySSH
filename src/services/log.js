...
class LogService {
  ...
  _log(level, message, data) {
    ...
    if (this.enableConsole) {
      ...
      switch (level) {
        case 'debug':
          console.debug(`[${timestamp}] [DEBUG] ${message}`, consoleData)
          break
        case 'info':
          console.info(`[${timestamp}] [INFO] ${message}`, consoleData)
          break
        case 'warn':
          console.warn(`[${timestamp}] [WARN] ${message}`, consoleData)
          break
        case 'error':
          console.error(`[${timestamp}] [ERROR] ${message}`, consoleData)
          break
      }
    }
  }
