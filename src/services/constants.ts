import log from './log';
import type { ConnectionSettings, TerminalOptions } from '@/types/settings';
...
export const getDynamicConstants = (settings?: {
  ...
  try {
    ...
    // 安全获取连接设置
    let connectionSettings: ConnectionSettings = {} as ConnectionSettings;
    try {
    ...
    // 安全获取终端设置
    let terminalSettings: TerminalOptions = {} as TerminalOptions;
    try {
