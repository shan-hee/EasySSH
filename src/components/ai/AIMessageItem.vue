<template>
  ...
  >
    ...
    <div v-if="message.type === 'user'" class="ai-user-message-wrapper">
      <div class="ai-user-time">{{ formatTime(message.timestamp) }}</div>
      <div class="ai-user-bubble">
        <div class="ai-user-content">{{ message.content }}</div>
      </div>
    </div>
    ...
    <template v-else>
      ...
      <!-- 纯文本消息 -->
      <div v-if="!hasCodeBlocks" class="ai-message-text" v-html="formattedContent"></div>
      ...
      <div v-else class="ai-message-mixed">
        ...
        >
          <!-- 文本部分 -->
          <div v-if="part.type === 'text'" class="ai-message-text" v-html="part.content"></div>
...
const formattedContent = computed(() => {
  return messageParseResult.value.formattedContent
})

const parsedContent = computed(() => {
  return messageParseResult.value.parsedContent
})
