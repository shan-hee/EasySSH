...
export const SHADCN_STUDIO_PRESET_STYLES: Record<string, ThemePresetSource> = {
  marshmallow: {
    light: {
      ...
      'font-sans': 'Gabriela, var(--font-inter), ui-sans-serif',
      'font-serif': 'Gabriela, Georgia, ui-serif',
  ...
  'vs-code': {
    light: {
      ...
      'font-sans':
        "'Source Code Pro', var(--font-inter), ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'",
      'font-serif':
        "'Source Serif 4', Georgia, ui-serif, Cambria, 'Times New Roman', Times, serif",
      'font-mono':
        "'Source Code Pro', var(--font-jetbrains-mono), ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace",
      radius: '0rem',
  ...
  spotify: {
    light: {
      ...
      'font-serif': 'Merriweather, Georgia, ui-serif, Cambria, "Times New Roman", Times, serif',
      'font-mono':
        'Roboto Mono, var(--font-jetbrains-mono), ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace',
